...
bool SingleTableParquetReader::start() { return readNextRowGroup() && readNextRow(); }

bool SingleTableParquetReader::skipRow() { return readNextRow(); }
...
void SingleTableParquetReader::dispatchRow( bool doReadNextRow ) { dispatchRow( doReadNextRow, getCurSymbol() ); }
...
bool SingleTableParquetReader::hasData() const { return m_curTable != nullptr; }
...
bool MultipleFileParquetReader::hasData() const { return !m_columnReaders.empty() && m_columnReaders[0]->hasData(); }

void MultipleFileParquetReader::clear() { m_columnReaders.clear(); }
