...
#define CSP_DECLARE_EXCEPTION( DerivedException, BaseException ) class CSPCORE_EXPORT DerivedException : public BaseException { public: DerivedException( const char * exType, const std::string &r, const char * file, const char * func, int line ) : BaseException( exType, r, file, func, line ) {} };
