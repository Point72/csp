...
#define TS_INPUT( Type, Name )                                                                                         \
    typename InputTypeHelper<Type>::type Name { #Name, *this }
#define TS_INPUT_RENAMED( Type, DeclName, VarName )                                                                    \
    typename InputTypeHelper<Type>::type VarName { #DeclName, *this }
#define TS_LISTBASKET_INPUT( Type, Name )                                                                              \
    typename ListInputBasketTypeHelper<Type>::type Name { #Name, *this }
#define TS_DICTBASKET_INPUT( Type, Name )                                                                              \
    typename DictInputBasketTypeHelper<Type>::type Name { #Name, *this }

#define TS_OUTPUT( Type )                                                                                              \
    typename OutputTypeHelper<Type>::type __unnamed_output{ "", *this };                                               \
    auto & unnamed_output() { return __unnamed_output; }
...
#define TS_NAMED_LISTBASKET_OUTPUT( Type, Name )                                                                       \
    typename ListOutputBasketTypeHelper<Type>::type Name { #Name, *this }
...
#define TS_NAMED_OUTPUT( Type, Name )                                                                                  \
    typename OutputTypeHelper<Type>::type Name { #Name, *this }
#define TS_NAMED_OUTPUT_RENAMED( Type, DeclName, VarName )                                                             \
    typename OutputTypeHelper<Type>::type VarName { #DeclName, *this }

#define ALARM( Type, Name )                                                                                            \
    typename AlarmTypeHelper<Type>::type Name { #Name, *this }
