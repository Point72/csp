...
void DynamicEngine::GraphOutput::start() { input()->removeConsumer( this, InputId( 0 ) ); }
...
TimeSeriesProvider * DynamicEngine::outputTs( const std::string & key ) { return m_graphOutputs[key]->input(); }

void DynamicEngine::shutdown() { m_shutdownFn(); }
