...
inline Scheduler::Handle RootEngine::reserveSchedulerHandle() { return m_scheduler.reserveHandle(); }
...
inline void RootEngine::cancelCallback( Scheduler::Handle handle ) { m_scheduler.cancelCallback( handle ); }
