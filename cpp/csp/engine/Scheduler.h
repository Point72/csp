...
inline bool Scheduler::Handle::expired() const { return !event || event->id != id; }

inline DateTime Scheduler::Handle::time() const { return expired() ? DateTime::NONE() : event->mapIt->first; }

inline Scheduler::Handle Scheduler::reserveHandle() { return Handle{ ++m_unique, nullptr }; }
