...
inline DateTime TimeSeriesProvider::timeAtIndex( int32_t index ) const { return m_timeseries->timeAtIndex( index ); }
...
inline void TimeSeriesProvider::propagate() { m_propagator.propagate(); }
