 ...
 */
CSP_C_API_EXPORT CCspPushInputAdapterHandle ccsp_push_input_adapter_extern_create( CCspEngineHandle engine, CCspType type,
 ...
 */
CSP_C_API_EXPORT CCspErrorCode ccsp_push_input_adapter_push_value( CCspPushInputAdapterHandle adapter, const CCspValue * value,
                                                                   CCspPushBatchHandle batch );

/* Type-specific push functions (more efficient, avoid CCspValue overhead) */

CSP_C_API_EXPORT CCspErrorCode ccsp_push_input_adapter_push_bool( CCspPushInputAdapterHandle adapter, int8_t value,
                                                                  CCspPushBatchHandle batch );

CSP_C_API_EXPORT CCspErrorCode ccsp_push_input_adapter_push_int8( CCspPushInputAdapterHandle adapter, int8_t value,
                                                                  CCspPushBatchHandle batch );

CSP_C_API_EXPORT CCspErrorCode ccsp_push_input_adapter_push_uint8( CCspPushInputAdapterHandle adapter, uint8_t value,
                                                                   CCspPushBatchHandle batch );

CSP_C_API_EXPORT CCspErrorCode ccsp_push_input_adapter_push_int16( CCspPushInputAdapterHandle adapter, int16_t value,
                                                                   CCspPushBatchHandle batch );

CSP_C_API_EXPORT CCspErrorCode ccsp_push_input_adapter_push_uint16( CCspPushInputAdapterHandle adapter, uint16_t value,
                                                                    CCspPushBatchHandle batch );

CSP_C_API_EXPORT CCspErrorCode ccsp_push_input_adapter_push_int32( CCspPushInputAdapterHandle adapter, int32_t value,
                                                                   CCspPushBatchHandle batch );

CSP_C_API_EXPORT CCspErrorCode ccsp_push_input_adapter_push_uint32( CCspPushInputAdapterHandle adapter, uint32_t value,
                                                                    CCspPushBatchHandle batch );

CSP_C_API_EXPORT CCspErrorCode ccsp_push_input_adapter_push_int64( CCspPushInputAdapterHandle adapter, int64_t value,
                                                                   CCspPushBatchHandle batch );

CSP_C_API_EXPORT CCspErrorCode ccsp_push_input_adapter_push_uint64( CCspPushInputAdapterHandle adapter, uint64_t value,
                                                                    CCspPushBatchHandle batch );

CSP_C_API_EXPORT CCspErrorCode ccsp_push_input_adapter_push_double( CCspPushInputAdapterHandle adapter, double value,
                                                                    CCspPushBatchHandle batch );

CSP_C_API_EXPORT CCspErrorCode ccsp_push_input_adapter_push_datetime( CCspPushInputAdapterHandle adapter, CCspDateTime value,
                                                                       CCspPushBatchHandle batch );

CSP_C_API_EXPORT CCspErrorCode ccsp_push_input_adapter_push_timedelta( CCspPushInputAdapterHandle adapter, CCspTimeDelta value,
                                                                        CCspPushBatchHandle batch );
 ...
 */
CSP_C_API_EXPORT CCspErrorCode ccsp_push_input_adapter_push_string( CCspPushInputAdapterHandle adapter, const char * data,
                                                                    size_t length, CCspPushBatchHandle batch );

/*
 * Push a struct value.
 * The struct is copied internally.
 */
CSP_C_API_EXPORT CCspErrorCode ccsp_push_input_adapter_push_struct( CCspPushInputAdapterHandle adapter,
