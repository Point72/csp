...
bool PyBaseBasketInputProxy::ticked() const { return basketInfo()->ticked(); }

bool PyBaseBasketInputProxy::valid() const { return basketInfo()->allValid(); }

InputBasketInfo * PyBaseBasketInputProxy::basketInfo() { return m_node->inputBasket( m_id ); }

bool PyBaseBasketInputProxy::makeActive() { return m_node->makeBasketActive( m_id ); }

bool PyBaseBasketInputProxy::makePassive() { return m_node->makeBasketPassive( m_id ); }
...
bool PyDictBasketInputProxy::contains( PyObject * key ) { return PyDict_Contains( m_proxyMapping.ptr(), key ); }
