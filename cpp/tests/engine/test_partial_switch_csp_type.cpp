...
{
    return csp::ConstructibleTypeSwitch<T>::invoke(
        curType.get(), []( auto tag )
...
TEST( ConstructibleTypeSelectorTest, test_basic_type_support )
{
    ...
    runTypeConversionSupportTest<csp::CspType::Type::INT8>( { csp::CspType::Type::BOOL, csp::CspType::Type::INT8,
    ...
    runTypeConversionSupportTest<csp::CspType::Type::UINT8>(
        { csp::CspType::Type::BOOL, csp::CspType::Type::UINT8, csp::CspType::Type::INT16, csp::CspType::Type::UINT16,
          csp::CspType::Type::INT32, csp::CspType::Type::UINT32, csp::CspType::Type::INT64, csp::CspType::Type::UINT64,
          csp::CspType::Type::DOUBLE },
        { csp::CspType::Type::INT8 } );

    runTypeConversionSupportTest<csp::CspType::Type::INT16>(
        { csp::CspType::Type::BOOL, csp::CspType::Type::INT16, csp::CspType::Type::INT32, csp::CspType::Type::INT64,
          csp::CspType::Type::DOUBLE },
        { csp::CspType::Type::UINT8, csp::CspType::Type::INT8, csp::CspType::Type::UINT16, csp::CspType::Type::UINT32,
          csp::CspType::Type::UINT64 } );

    runTypeConversionSupportTest<csp::CspType::Type::UINT16>(
        { csp::CspType::Type::BOOL, csp::CspType::Type::UINT16, csp::CspType::Type::INT32, csp::CspType::Type::UINT32,
    ...
    runTypeConversionSupportTest<csp::CspType::Type::INT32>(
        { csp::CspType::Type::BOOL, csp::CspType::Type::INT32, csp::CspType::Type::INT64, csp::CspType::Type::DOUBLE },
        { csp::CspType::Type::UINT8, csp::CspType::Type::INT8, csp::CspType::Type::INT16, csp::CspType::Type::UINT16,
          csp::CspType::Type::UINT32, csp::CspType::Type::UINT64 } );

    runTypeConversionSupportTest<csp::CspType::Type::UINT32>( { csp::CspType::Type::BOOL, csp::CspType::Type::UINT32,
    ...
    runTypeConversionSupportTest<csp::CspType::Type::INT64, double>(
        ...
        { csp::CspType::Type::UINT8, csp::CspType::Type::INT8, csp::CspType::Type::INT16, csp::CspType::Type::UINT16,
          csp::CspType::Type::INT32, csp::CspType::Type::UINT32, csp::CspType::Type::UINT64 } );

    runTypeConversionSupportTest<csp::CspType::Type::UINT64, double>(
        { csp::CspType::Type::BOOL, csp::CspType::Type::UINT64, csp::CspType::Type::INT64, csp::CspType::Type::DOUBLE },
        {
            csp::CspType::Type::INT8,
            csp::CspType::Type::UINT8,
            csp::CspType::Type::INT16,
...
TEST( ArraySwitchTest, test_basic_switch )
{
    ...
    csp::PrimitiveCspTypeSwitch::invoke( uint64Type.get(),
                                         []( auto tag )
                                         {
    ...
    csp::PartialSwitchCspType<csp::CspType::Type::INT16, csp::CspType::Type::ARRAY>::invoke(
        uint64ArrayType.get(),
        []( auto tag ) { verifySameTypes<typename decltype( tag )::type, std::vector<std::uint64_t>>(); } );
    csp::PartialSwitchCspType<csp::CspType::Type::ARRAY>::invoke(
        uint64ArrayType.get(),
        []( auto tag ) { verifySameTypes<typename decltype( tag )::type, std::vector<std::uint64_t>>(); } );
    csp::PartialSwitchCspType<csp::CspType::Type::ARRAY>::invoke(
        boolArrayType.get(),
        []( auto tag ) { verifySameTypes<typename decltype( tag )::type, std::vector<uint8_t>>(); } );
    ...
    ASSERT_THROW( csp::PartialSwitchCspType<csp::CspType::Type::ARRAY>::invoke<
                      csp::PartialSwitchCspType<csp::CspType::Type::BOOL>>( uint64ArrayType.get(), []( auto tag ) {} ),
                  csp::UnsupportedSwitchType );

    // Should raise since we support only array of uint64_t
    ASSERT_THROW( csp::PartialSwitchCspType<csp::CspType::Type::ARRAY>::invoke<
                      csp::PartialSwitchCspType<csp::CspType::Type::UINT64>>( boolArrayType.get(), []( auto tag ) {} ),
                  csp::UnsupportedSwitchType );
}
