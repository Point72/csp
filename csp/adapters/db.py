...
# GRAPH TIME
class DBReader:
    def __init__(self, connection, time_accessor, table_name=None, schema_name=None, query=None, symbol_column=None,
                 constraint=None,log_query=False, use_raw_user_query=False):
        """
    ...
    @classmethod
    def create_from_connection(cls, connection, time_accessor, table_name=None, schema_name=None, query=None,
                               symbol_column=None, constraint=None,log_query=False):
        return cls(connection, time_accessor, table_name, schema_name, query, symbol_column, constraint,log_query)

    @classmethod
    def create_from_url(cls, url, time_accessor, table_name=None, schema_name=None, query=None, symbol_column=None,
                        constraint=None,log_query=False):
        return cls(db.create_engine(url), time_accessor, table_name, schema_name, query, symbol_column, constraint,log_query)
...
DBReadAdapter = py_managed_adapter_def('dbadapter', DBReadAdapterImpl, ts['T'], DBReader, symbol=object, typ='T',
