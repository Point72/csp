...
class KafkaAdapterManager:
    def __init__(
        ...
        consumer_properties = rd_kafka_consumer_conf_options.copy() if rd_kafka_producer_conf_options else {}
        ...
        producer_properties = rd_kafka_consumer_conf_options.copy() if rd_kafka_producer_conf_options else {}
