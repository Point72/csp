...
@csp.node
def flatten_numpy_array(x: csp.ts[csp.typing.NumpyNDArray['T']]) -> csp.Outputs(value=csp.ts[csp.typing.Numpy1DArray['T']], shape=csp.ts[csp.typing.Numpy1DArray[int]]):
...
@csp.node
def reshape_numpy_array(value: csp.ts[csp.typing.Numpy1DArray['T']], shape: csp.ts[csp.typing.Numpy1DArray[int]]) -> csp.ts[csp.typing.NumpyNDArray['T']]:
