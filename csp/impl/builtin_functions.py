...
@csp_builtin
def value_at(series: GenericTSTypes['T'].TS_TYPE, index_or_time: Union[int, timedelta, datetime, None] = 0,
             duplicate_policy: int = DuplicatePolicy.LAST_VALUE, default: Any = UNSET):
...
@csp_builtin
def time_at(series: GenericTSTypes['T'].TS_TYPE, index_or_time: Union[int, timedelta, datetime, None] = 0,
            duplicate_policy: int = DuplicatePolicy.LAST_VALUE, default: Any = UNSET):
...
@csp_builtin
def item_at(series: GenericTSTypes['T'].TS_TYPE, index_or_time: Union[int, timedelta, datetime, None] = 0,
            duplicate_policy: int = DuplicatePolicy.LAST_VALUE, default: Any = UNSET):
...
@csp_builtin
def values_at(series: GenericTSTypes['T'].TS_TYPE, start_index_or_time: Union[int, timedelta, datetime, None] = None,
              end_index_or_time: Union[int, timedelta, datetime, None] = None,
              start_index_policy: TimeIndexPolicy = TimeIndexPolicy.INCLUSIVE, end_index_policy: TimeIndexPolicy = TimeIndexPolicy.INCLUSIVE):
...
@csp_builtin
def times_at(series: GenericTSTypes['T'].TS_TYPE, start_index_or_time: Union[int, timedelta, datetime, None] = None,
             end_index_or_time: Union[int, timedelta, datetime, None] = None,
             start_index_policy: TimeIndexPolicy = TimeIndexPolicy.INCLUSIVE, end_index_policy: TimeIndexPolicy = TimeIndexPolicy.INCLUSIVE):
...
@csp_builtin
def items_at(series: GenericTSTypes['T'].TS_TYPE, start_index_or_time: Union[int, timedelta, datetime, None] = None,
             end_index_or_time: Union[int, timedelta, datetime, None] = None,
             start_index_policy: TimeIndexPolicy = TimeIndexPolicy.INCLUSIVE, end_index_policy: TimeIndexPolicy = TimeIndexPolicy.INCLUSIVE):
...
@csp_builtin
def set_buffering_policy(ts_or_basket: GenericTSTypes['T'].TS_OR_BASKET_TYPE, tick_count: int = None, tick_history: timedelta = None):
    ...
    """
    raise RuntimeError("Unexpected use of csp.set_buffering_policy, csp.set_buffering_policy can only be used inside a node")
...
def remove_dynamic_key(basket: GenericTSTypes['T'].TS_TYPE, key: Any):
    ...
    """
    raise RuntimeError("Unexpected use of csp.remove_dynamic_key, csp.remove_dynamic_key can only be used inside a node")
