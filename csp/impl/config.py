...
class BaseCacheConfig(Struct):
    ...
    lock_file_permissions: FilePermissions = FilePermissions(user_permissions=RWXPermissions.READ | RWXPermissions.WRITE,
                                                             group_permissions=RWXPermissions.READ | RWXPermissions.WRITE,
                                                             others_permissions=RWXPermissions.READ | RWXPermissions.WRITE)
    data_file_permissions: FilePermissions = FilePermissions(user_permissions=RWXPermissions.READ | RWXPermissions.WRITE,
