...
class GenericValuesResolver(object):
    ...
    def resolve_generic_values(cls, typ: type, generic_values_container: typing.Dict[str, type]):
        ...
        if CspTypingUtils.is_forward_ref(typ):
            ...
            return OutputBasketContainer(typ=cls.resolve_generic_values(typ.typ, generic_values_container),
                                shape=typ.shape, eval_type=typ.eval_type, shape_func=typ.shape_func,
                                **typ.ast_kwargs)
