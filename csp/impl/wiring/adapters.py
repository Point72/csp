...
class InputAdapterDef(AdapterDef):
    ...
    def _create(self, engine, memo):
        ...
        return self._impl(manager, engine,
...
def _adapterdef(BaseDef, name, create_method, out_type, manager_type, memoize=True, force_memoize=False, **kwargs):
    ...
    adaptertype = AdapterDefMeta(name, (BaseDef,),
...
def input_adapter_def(name, adapterimpl, out_type, manager_type=None, memoize=True, force_memoize=False, **kwargs):
    ...
    return _adapterdef(InputAdapterDef, name, impl, out_type, manager_type, memoize=memoize, force_memoize=force_memoize, **kwargs)
...
def py_pull_adapter_def(name, adapterimpl, out_type, memoize=True, force_memoize=False, **kwargs):
    ...
    return _adapterdef(InputAdapterDef, name, impl, out_type, manager_type=None, memoize=memoize, force_memoize=force_memoize, **kwargs)
...
def py_push_adapter_def(name, adapterimpl, out_type, manager_type=None, memoize=True, force_memoize=False, **kwargs):
    ...
    return _adapterdef(InputAdapterDef, name, impl, out_type, manager_type, memoize=memoize, force_memoize=force_memoize, **kwargs, push_group=(object, None))

def py_pushpull_adapter_def(name, adapterimpl, out_type, manager_type=None, memoize=True, force_memoize=False, **kwargs):
    """
    :param name:
    :param adapterimpl:
    :param out_type:
...
def output_adapter_def(name, adapterimpl, manager_type=None, memoize=True, force_memoize=False, **kwargs):
    ...
    :return:
    """
    return _adapterdef(OutputAdapterDef, name, adapterimpl, None, manager_type, memoize=memoize, force_memoize=force_memoize, **kwargs)
...
def py_output_adapter_def(name, adapterimpl, manager_type=None, memoize=True, force_memoize=False, **kwargs):
    ...
    return _adapterdef(OutputAdapterDef, name, impl, None, manager_type, memoize=memoize, force_memoize=force_memoize, **kwargs)



add_graph_output      = output_adapter_def('add_graph_output', _cspimpl._graph_output_adapter, key=object, input=tstype.ts['T'], tick_count=(int, -1), tick_history=(timedelta, timedelta()))
_graph_return_adapter = output_adapter_def('_graph_return', _cspimpl._graph_return_adapter, key=object, input=tstype.ts['T'])