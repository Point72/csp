...
class Context:
    ...
    def __init__(self, start_time: datetime = None, end_time: datetime = None, config: Optional[Config] = None, is_global_instance: bool = False):
        ...
        self.cache_data = ContextCacheInfo(cache_managers={}, managed_datasets_by_graph_object={},
