...
from   csp.impl.wiring import py_push_adapter_def, MAX_END_TIME
import csp
from   csp import ts
import threading
...
def run_on_thread(g, *args, starttime=None, endtime=MAX_END_TIME, config: Optional[Config] = None, queue_wait_time=None, realtime=False, auto_shutdown=False, daemon=False, **kwargs):
    return ThreadRunner(g, *args, starttime=starttime, endtime=endtime, config=config, queue_wait_time=queue_wait_time, realtime=realtime, auto_shutdown=auto_shutdown, daemon=daemon, **kwargs)
