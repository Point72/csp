from csp.impl.pandas_ext_type import TsDtype, TsArray
...
def edge_equality_mock(monkeypatch):
    ...
    def mock_eq(self, other):
        ...
        return self.run(starttime=datetime(2000, 1, 1), endtime=datetime(2000, 1, 1)) \
               == other.run(starttime=datetime(2000, 1, 1), endtime=datetime(2000, 1, 1))
