...
class TestNumbaDatetimeExtension(unittest.TestCase):
    ...
    def test_datetime(self):
        def _create_datetimes():
            return (datetime(2020, 1, 2), datetime(year=2020, month=1, day=2),
        ...
        numba_datetimes_diff = self._timedeltas_to_nanoseconds(_numba_diff_datetimes(numba_datetimes, self.NUMBA_EPOCH_START))
