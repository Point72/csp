...
class TestPipeApplyRun(unittest.TestCase):
    ...
    def test_pipe(self):
        ...
        out = inp.pipe((csp.sample,'x'), trigger=csp.timer(timedelta(hours=12))) \
                       .run(starttime=datetime(2020, 1, 1), endtime=datetime(2020, 1, 3))
        target = [(datetime(2020,1,1,12), 2), (datetime(2020,1,2), 3), (datetime(2020,1,2,12), 3), (datetime(2020,1,3), 3)]
        self.assertListEqual(out, target)
