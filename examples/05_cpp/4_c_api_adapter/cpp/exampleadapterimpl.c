...
/*
 * _example_input_adapter(manager_or_interval, ts_type, properties, push_mode) -> capsule
 *
 * Create an example input adapter that generates incrementing integers.
 * Can be used with or without an adapter manager.
 */
...
/*
 * _example_output_adapter(prefix: str = None) -> capsule
 *
