"""
Example Rust adapter usage.

This module demonstrates using Rust adapters implemented via the CSP C API.
...
def standalone_graph():
    """Graph using standalone Rust adapters (no manager)."""
...
def managed_graph():
    """
    Graph using managed Rust adapters (with adapter manager).
