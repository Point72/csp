...
# =============================================================================
# Example 9: Running Blocking Code in Executor
# =============================================================================
...
async def executor_example():
    ...
    # Run blocking operations in the default executor
    result1 = await loop.run_in_executor(None, blocking_io_operation, 5, 10)
    result2 = await loop.run_in_executor(None, blocking_io_operation, 3, 7)
